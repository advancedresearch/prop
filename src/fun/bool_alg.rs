...
pub fn eq_norm1_true1<F: Prop>(ty_f: Tauto<Ty<F, Pow<Bool, Bool>>>) -> Eq<SymNorm1<F, FTrue1>, FTrue1> {
    fn case<F: Prop, A: Prop>((ty_f, ty_a): And<Ty<F, Pow<Bool, Bool>>, Ty<A, Bool>>) -> Eq<App<SymNorm1<F, FTrue1>, A>, App<FTrue1, A>> {
